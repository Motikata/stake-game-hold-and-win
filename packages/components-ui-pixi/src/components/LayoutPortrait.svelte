...
<MainContainer standard alignVertical="bottom">
	...
	<Container y={drawerTween.current}>
		<Container
			...
			y={context.stateLayoutDerived.mainLayoutStandard().height - 100}
		>
			{@render props.buttonMenu({ anchor: 0.5 })}
		</Container>

		<Container
			x={context.stateLayoutDerived.mainLayoutStandard().width * 0.5 + 450}
			y={context.stateLayoutDerived.mainLayoutStandard().height - 730}
		>
		...
		>
			{@render props.buttonAutoSpin({ anchor: 0.5, scale:1})}
		</Container>
		...
		<Container
			...
			y={context.stateLayoutDerived.mainLayoutStandard().height - 300}
		>
			{@render props.buttonTurbo({ anchor: 0.5, scale:1})}
		</Container>

		<Container
			x={context.stateLayoutDerived.mainLayoutStandard().width- 950}
...
<MainContainer standard alignVertical="bottom">
	...
	{:else}
		...
		<Container
			...
			y={context.stateLayoutDerived.mainLayoutStandard().height - 400}
		>
			{@render props.buttonDecrease({ anchor: 0.5, scale:0.7 })}
		</Container>
		...
		<Container
			...
			y={context.stateLayoutDerived.mainLayoutStandard().height - 400}
		>
			{@render props.buttonIncrease({ anchor: 0.5,scale:0.7 })}
		</Container>
	{/if}
